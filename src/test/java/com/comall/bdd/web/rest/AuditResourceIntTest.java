...
import com.comall.bdd.config.audit.AuditEventConverter;
import com.comall.bdd.domain.PersistentAuditEvent;
import com.comall.bdd.repository.PersistenceAuditEventRepository;
import com.comall.bdd.service.AuditEventService;
...
@SpringBootTest(classes = BddDemoApp.class)
@Transactional
